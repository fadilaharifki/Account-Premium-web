...
const ProductIcon: React.FC<ProductProps> = ({ width = 20, height = 21, fill = "#FCFCFC" }) => {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" clip-rule="evenodd" d="M11.25 10.9875L2.6954 7.18541L3.3046 5.8147L12 9.67932L20.6954 5.8147L21.3046 7.18541L12.75 10.9875V21.5001H11.25V10.9875Z" fill="#FCFCFC" />
      <path
        fillRule="evenodd"
        clip-rule="evenodd"
